...
const SKIN_SHEETS := {
	...
	# The pack only ships fishing and hook sheets for these characters; generated six-frame walk sheets use the canonical movement layout.
	"skin_grave_robber": {"fishing": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/GraveRobber_fish_clean.png"), "idle": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/GraveRobber_fish_clean.png"), "hook": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/GraveRobber_hook.png"), "walk_right": preload("res://assets/skins/grave_robber/GraveRobber_walk_generated.png")},
	"skin_steam_man": {"fishing": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/SteamMan_fish_clean.png"), "idle": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/SteamMan_fish_clean.png"), "hook": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/SteamMan_hook.png"), "walk_right": preload("res://assets/skins/steam_man/SteamMan_walk_generated.png")},
	"skin_woodcutter": {"fishing": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/Woodcutter_fish_clean.png"), "idle": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/Woodcutter_fish_clean.png"), "hook": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/Woodcutter_hook.png"), "walk_right": preload("res://assets/skins/woodcutter/Woodcutter_walk_generated.png")},
}
