...
const ITEMS := {
	...
	"skin_grave_robber": {"category": "skins", "name": "Grave Robber", "description": "Fresh from a very quiet shift.", "price": 350, "icon": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/GraveRobber_fish.png"), "region": Rect2(0, 0, 48, 48)},
	"skin_steam_man": {"category": "skins", "name": "Steam Man", "description": "Pressurized, punctual, and faintly alarming.", "price": 400, "icon": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/SteamMan_fish.png"), "region": Rect2(0, 0, 48, 48)},
	"skin_woodcutter": {"category": "skins", "name": "Woodcutter", "description": "Splinters, sawdust, and a sturdy rod.", "price": 300, "icon": preload("res://assets/free-fishing-game-assets-pixel-art-pack/2 Character animation/Woodcutter_fish.png"), "region": Rect2(0, 0, 48, 48)},
